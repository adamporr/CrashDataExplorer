...
var aboutDescription = 'Columbus Crash Data Explorer is a web application that allows users to explore patterns of pedestrian and cyclist crashes in the Columbus metropolitan area and understand their connection to different communities and built environments. It was developed at The Ohio State University with the support of <a href="https://cura.osu.edu/">The Center for Urban and Regional Analysis (CURA)</a> through a <a href="https://steamfactory.osu.edu/">STEAM Factory</a> postdoctoral research fellowship.'
